            ...
            <div className={styles.container}>
                <Box sx={{ width: '100%' }}>
                    <Grid container className={stylesIndex.grid}>
                        ...
                        <Grid item lg={6} md={6} sm={12} xs={12} className={stylesIndex.item}>
                            <div className={stylesIndex.intro}>
                    ...
                    <Box sx={{ width: '100%' }}>
                        <Grid container>
                            <Grid item lg={3} md={3} sm={12} xs={12} className={isMobile ? stylesIndex.itemCard : null}>
                                <Cardlet icon={<ion-icon name="home"></ion-icon>} title={'15 Years Experience'} desc={'Our technicians are fully equiped to effeciently repair your equipment with minimal downtime!'} />
                            </Grid>
                            <Grid item lg={3} md={3} sm={12} xs={12} className={isMobile ? stylesIndex.itemCard : null}>
                                <Cardlet icon={<ion-icon name="home"></ion-icon>} title={'All Inclusive'} desc={'From Oil Free to Rotary Screw, our technicians can handle the pressure!'} />
                            </Grid>
                            <Grid item lg={3} md={3} sm={12} xs={12} className={isMobile ? stylesIndex.itemCard : null}>
                                <Cardlet icon={<ion-icon name="home"></ion-icon>} title={'Breakdowns'} desc={'24/7 breakdown service, any time day or night. Our team is ready to support all your compressed air needs!'} />
                            </Grid>
                            <Grid item lg={3} md={3} sm={12} xs={12} className={isMobile ? stylesIndex.itemCard : null}>
                                <Cardlet icon={<ion-icon name="home"></ion-icon>} title={'Quality Service'} desc={'With the use of quality parts and a team who cares, rest assured your equipment is well looked after!'} />
                            </Grid>
                        </Grid>
                    </Box>
                    <Link href='/services'>
